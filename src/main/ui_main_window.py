...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.buttons_frame = QFrame(self.layoutWidget1)
        ...
        self.btn_clear_plots = QPushButton(self.layoutWidget1)
        ...
        self.remove_lbl = QLabel(self.layoutWidget1)
        ...
        self.remove_cbx = QComboBox(self.layoutWidget1)
        ...
        self.marker_cbx = QComboBox(self.layoutWidget1)
        ...
        self.line_style_cbx = QComboBox(self.layoutWidget1)
        ...
        self.draw_style_cbx = QComboBox(self.layoutWidget1)
